...
A unique code that is used for authentication. Enables users to access protected routes.

- [ ] What steps can you take in your web apps to keep your data secure?

Hvae a login page as well as using protected private routes.

- [ ] Describe how web servers work.

Servers store data that users access through web browsers.
